    ...
    return (
        <section id="about" className="section">
            ...
            <p className="summary">Hi! I'm Sophia, a Computer Science graduate from the University of North Texas currently working as an AI Red Teaming Expert at Scale AI. My role involves analyzing AI model behavior, organizing datasets, and finding patterns that help improve AI safety, and I love every part of it.<br/><br/>
                                ...
                                I'm actively seeking opportunities in data science, data analysis, and evaluation roles. If you think I'd be a good fit for your team, let's talk! Reach me at <a href="https://mail.google.com/mail/?view=cm&fs=1&to=sophiadrewfs@gmail.com" target="_blank" rel="noopener noreferrer">sophiadrewfs@gmail.com</a>
            </p>
        </section>
    )
}
